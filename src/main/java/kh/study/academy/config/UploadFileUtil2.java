...
public class UploadFileUtil2 {
	//final : 상수(변하지 않고 항상 같은 값을 가지는 수)는 웬만하면 다 대문자로 이름 짓기
...
//	private static final String UPLOAD_PATH = "C:\\dev\\workspaceSTS\\AcademyProject\\src\\main\\resources\\static\\images\\board\\";
